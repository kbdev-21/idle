...
function handleDisconnect(ws) {
    ...
    if (connectedUser.get(ws.userId) !== ws)
        return;
...
// ===== Message handlers =====
async function handleCaroMatchmaking(ws) {
...
function handleCaroCancelMatchmaking(ws) {
    caroMatchmaking.leftCaroQueue(ws.userId);
}
async function handleCaroPlayTurn(ws, x, y) {
