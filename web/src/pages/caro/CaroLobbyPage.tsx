  ...
  return (
    <main className="mx-auto w-full max-w-md flex-1 px-4 pt-10 pb-16">
      ...
      <button
        ...
        className="mt-8 flex w-full items-center justify-between rounded-3xl border border-gray-300 bg-gray-100 px-5 py-4 text-left shadow-[0_4px_12px_rgba(0,0,0,0.08)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_18px_40px_-28px_rgba(30,30,50,0.4)] active:translate-y-0 active:duration-75"
      >
      ...
      <div className="mt-6 flex items-center justify-between px-1">
        ...
        <span className="flex items-center gap-1.5 text-xs font-medium text-muted-foreground">
          ...
          <span className="font-bold text-foreground">3,224</span> players
          online
        </span>
      </div>
